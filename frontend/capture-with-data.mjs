...
(async () => {
  ...
  console.log('Capture with data...');
  await page.screenshot({ path: '../../screenshots/customer-list-with-zhangsan.png', fullPage: true });
  
  const content = await page.content();
  if (content.includes('张三')) {
    console.log('✅ Customer "张三" is visible in the list!');
  }
