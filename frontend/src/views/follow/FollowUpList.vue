  ...
  <div class="followup-list">
    ...
    <el-card class="filter-card">
      <el-form :model="searchForm" inline>
        ...
        <el-form-item label="跟进方式">
          <el-select v-model="searchForm.contactType" placeholder="请选择" clearable style="width: 120px">
    ...
    <el-card class="table-card">
      <el-table 
        ...
        v-loading="loading"
      >
        <el-table-column prop="title" label="跟进标题" min-width="200" show-overflow-tooltip />
        <el-table-column prop="customerName" label="客户名称" min-width="120" />
        <el-table-column prop="contactType" label="跟进方式" width="100">
          <template #default="{ row }">
            <el-tag :type="getContactTypeType(row.contactType)">
              {{ getContactTypeText(row.contactType) }}
            </el-tag>
          </template>
        </el-table-column>
        <el-table-column prop="nextFollowTime" label="下次联系时间" width="160">
          <template #default="{ row }">
    ...
    >
      <el-form :model="form" :rules="rules" ref="formRef" label-width="100px">
        ...
        <el-form-item label="跟进方式" prop="contactType">
          <el-select v-model="form.contactType" placeholder="请选择跟进方式" style="width: 100%">
            <el-option label="电话" value="phone" />
            <el-option label="微信" value="wechat" />
            <el-option label="邮件" value="email" />
            <el-option label="拜访" value="visit" />
...
const rules = {
  ...
  content: [
    ...
    { min: 10, message: '跟进内容不能少于 10 个字符', trigger: 'blur' }
  ]
}
